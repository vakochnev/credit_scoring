...
Подробнее: [CI_CD_SETUP.md](CI_CD_SETUP.md), [DEPLOY.md](DEPLOY.md)
...
- **[DEPLOY.md](DEPLOY.md)** — подробное руководство по деплою на PythonAnywhere
...
- **[CI_CD_SETUP.md](CI_CD_SETUP.md)** — быстрый старт CI/CD
