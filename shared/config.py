...
Поддерживает переменные окружения для Docker.
"""
import os
import secrets

# Секретный ключ из переменной окружения или генерируется случайный
...
ROLES = {
    ...
    "analyst": "Аналитик - доступ к прогнозам, отчётам, фидбэкам",
    "user": "Пользователь - базовый доступ к прогнозам"
}
